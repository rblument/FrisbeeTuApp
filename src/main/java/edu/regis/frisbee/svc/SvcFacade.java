...
/**
 * A Facade that standardizes requests from the GUI Client to the FrisbeeTu 
 * tutor server via a socket connection with requests and replies encoded as
 * JSon encoded object strings
 *
...
public class SvcFacade {
     ...
     */
    private static final int PORT = 53638;
