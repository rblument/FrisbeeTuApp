...
import edu.regis.frisbee.err.MissingPropertyException;
 ...
 * CLASSPATH (default: Frisbee.properties in the /resources/ directory).
 * @author Rickb
 */
public class ResourceMgr {
     ...
     */
    private static final String PROPERTY_FILE_PATH = "/Frisbee.properties";
    ...
    /**
     * Local cache of properties loaded from the Frisbee.properties file.
     */
    private final Properties properties;
    
    /**
     * The current locale, as specified in the Frisbee.properties file
     */
     ...
     * 
     * @param path location of property file, e.g. "./Frisbee.properties"
     */
