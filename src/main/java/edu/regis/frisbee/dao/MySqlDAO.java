...
public abstract class MySqlDAO {
     ...
     */
    public static final String DB_HOST_PROP = "edu.regis.frisbee.DB_HOST";
    
    /**
     * The name of the ShaTu database (see /resources/ShaTu.Properties).
     */
    public static final String DB_NAME_PROP = "edu.regis.frisbee.DB_NAME";
    
    /**
     * The DB user used by ShaTu to login (see /resources/ShaTu.Properties).
     */
    public static final String DB_USER_PROP = "edu.regis.frisbee.DB_USER";
    
    /**
     * The password used by ShaTu to login into the DB.
     */
    public static final String DB_PASS_PROP = "edu.regis.frisbee.DB_PASS";
