...
import edu.regis.frisbee.svc.SHA_256;
import edu.regis.frisbee.view.act.NewUserAction;
import edu.regis.frisbee.view.act.SignInAction;
...
/**
 * A splash panel introducing the Frisbee tutor, which also allows the user to 
...
public class SplashPanel extends GPanel {
	...
	JLabel newLabel = new JLabel("New to Frisbee?");
	...
	JLabel logo = new JLabel("Frisbee: Formal Logic Tutor");
	...
	descr.append("Frisbee provides individualized tutoring practice focused ");
	descr.append("on understanding Formal Logic and the");
