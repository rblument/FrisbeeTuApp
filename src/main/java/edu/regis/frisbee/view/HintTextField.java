...
/**
 * A JTextField with default text appearing in grey that disappears when a user
 * enters anything, but reappears if the all user enter text is removed.
 *
 * This field also intercepts focus events and moves the caret to offset 0, if
...
public class HintTextField extends JTextField {
     ...
     * entered one or more legal characters and restoring it when the user has
     * removed all legal characters.
     */
    public class NameFilter extends DocumentFilter {
        ...
        /**
         * If the user enters a non-space initial character, replace the default
         * hint text with the user's character switching to black.
         *
         */
